        ...
        <div id="contact" className="flex flex-col md:flex-row justify-between items-start">
          ...
          <div className="mb-4 md:w-1/3">
            ...
            <p>
              Email:{' '}
              <a
                href="mailto:contact@ecell-nitt.org"
                className="text-gray-300 hover:text-[#fdcf41]"
              >
                contact@ecell-nitt.org
              </a>
            </p>
            <p>
              Phone: <span className="text-gray-300">+91 8529312938</span>
            </p>
            <p>
              Address:
              <a
                href="https://maps.app.goo.gl/ggtiSJF4pDNUHaHq5"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-200 ml-1 hover:underline"
              >
          ...
          <div className="mb-4 md:w-1/3 text-center">
            ...
            <div className="flex justify-center space-x-6">
              <a
                href="https://www.facebook.com/ecell.nit.trichy/"
                rel="noopener noreferrer"
                target="_blank"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://www.linkedin.com/company/ecellnitt/mycompany/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
              >
              ...
              <a
                href="https://www.instagram.com/ecellnitt/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.youtube.com/@ECellNITTrichy"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
              >
          ...
          <div className="mb-4 md:w-1/3 text-right">
            ...
            <a href="https://ecell-nitt.org/#" className="hover:text-gray-400 mt-2 inline-block">
              <img
                ...
                alt="E-Cell Website"
                className="h-16 w-auto mt-2 transition-transform transform hover:scale-105"
              />
            </a>
          </div>
        </div>
