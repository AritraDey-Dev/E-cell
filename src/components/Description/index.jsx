function Description() {
  return (
    ...
    >
      <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-900 mb-4">About Us</h2>
      <p className="text-base sm:text-lg text-center text-gray-700 mb-6">
        At SIP, we create opportunities that go beyond internships.<br></br> it&apos;s your
        launchpad into the startup ecosystem!
      </p>
      {/* What is SIP Section */}
      <div className="mb-6">
        <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2">What We Do</h3>
        <p className="text-base sm:text-lg text-gray-700">
          SIP links ambitious students with dynamic startups, offering real-world exposure and a
      ...
      <div className="mt-4">
        ...
        <p className="text-base sm:text-0.5xl text-gray-700">
          Beyond internships, we offer mentorship and skill-building workshops, setting you up for a
          bright future in tech and business.
        </p>
      </div>
    </div>
  );
