...
function Description() {
  return (
    <div
      id="about"
      className="max-w-4xl mx-auto p-4 sm:p-6 mt-12 backdrop-blur-md bg-white/50 rounded-lg shadow-lg border border-gray-200 hover:border-[#f2d600] transition-colors duration-300 no-select"
    >
